...
class Email
{
    ...
    /* Enviar la confirmación para la recuperación */
    public function enviarInstrucciones()
    {
        ...
        $contenido .= "<p>¡Oh no! Al parecer te has olvidado de tu contraseña. La puedes recuperar haciendo click en el siguiente enlace: </p>";
